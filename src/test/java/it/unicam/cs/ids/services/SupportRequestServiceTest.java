...
//import it.unicam.cs.ids.repositories.ISupportRequestRepository;
//import it.unicam.cs.ids.repositories.ITeamRepository;
...
//        when(supportRequestRepository.findByHackathonId(100L)).thenReturn(new ArrayList<>());
...
//        when(teamRepository.getById(10L)).thenReturn(mockTeam);
//        when(hackathonRepository.getById(100L)).thenReturn(mockHackathon);
//        when(supportRequestRepository.findByHackathonId(100L)).thenReturn(List.of(existingRequest));
//
//        assertThrows(IllegalStateException.class, () -> supportRequestService.createRequest(validCreateRequest));
//        verify(supportRequestRepository, never()).create(any());
//    }
...
//        when(teamRepository.getById(10L)).thenReturn(mockTeam);
//        when(hackathonRepository.getById(100L)).thenReturn(mockHackathon);
//        when(supportRequestRepository.findByHackathonId(100L)).thenReturn(List.of(oldRequest));
//        when(supportRequestRepository.create(any(SupportRequest.class))).thenAnswer(i -> i.getArgument(0));
//
//        SupportRequestResponseDTO result = supportRequestService.createRequest(validCreateRequest);
//
...
//
//        when(hackathonRepository.getById(100L)).thenReturn(mockHackathon);
//        when(supportRequestRepository.findByHackathonId(100L)).thenReturn(List.of(req1));
//
