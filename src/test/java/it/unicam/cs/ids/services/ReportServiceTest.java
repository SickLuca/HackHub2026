...
//import it.unicam.cs.ids.repositories.IReportRepository;
//import it.unicam.cs.ids.repositories.IStaffUserRepository;
...
//        when(hackathonRepository.getById(100L)).thenReturn(mockHackathon);
//        when(reportRepository.findByHackathonId(100L)).thenReturn(List.of(mockReport));
//
